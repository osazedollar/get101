...
navbarItems.forEach(navbarItem => {
  // Find the inner list within the navbar item
  const innerList = navbarItem.querySelector('.inner-list');

  // Add event listener for mouseenter event to show the inner list
  navbarItem.addEventListener('mouseenter', function() {
    innerList.style.display = 'block';
  });

  // Add event listener for mouseleave event to hide the inner list
